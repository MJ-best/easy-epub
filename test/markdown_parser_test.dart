...
''';
    ...
    test('스타일 클래스 힌트를 heading과 문단에 주입한다', () {
      const markdown = '''
# 장 제목
...
''';
      ...
      final html = MarkdownParser.parseToHtml(
        markdown,
        options: const MarkdownRenderOptions(
      ...
      expect(html.contains('<h1 class="h1 chapter-title">장 제목</h1>'), true);
      expect(html.contains('<p class="txt bl body-copy">본문 문단</p>'), true);
    });
